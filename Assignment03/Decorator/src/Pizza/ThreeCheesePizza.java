package Pizza;// By going this route I'll have to create a new subclass
// for an infinite number of pizza.
// I'd also have to change prices in many classes
// when just 1 Pizza.Pizza topping cost changes
...
public class ThreeCheesePizza implements Pizza {
	...
	private String description = "Pizza.Mozzarella, Fontina, Parmesan Cheese Pizza.Pizza";
